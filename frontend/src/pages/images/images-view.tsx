...
const ImagesView = () => {
    ...
    return (
      <>
          ...
          <SectionMain>
            <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={removeLastCharacter('View images')} main>
                <BaseButton
                  color='info'
                  label='Edit'
                  href={`/images/images-edit/?id=${id}`}
                />
            ...
            <CardBox>
                ...
                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>organizations</p>
                        ...
                        <p>{images?.organizations?.name ?? 'No data'}</p>
