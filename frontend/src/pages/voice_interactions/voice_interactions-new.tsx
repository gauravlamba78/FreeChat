...
import { create } from '../../stores/voice_interactions/voice_interactionsSlice'
...
Voice_interactionsNew.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default Voice_interactionsNew
