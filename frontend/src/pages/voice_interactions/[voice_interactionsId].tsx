...
const EditVoice_interactions = () => {
  ...
  const { voice_interactionsId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: voice_interactionsId }))
  }, [voice_interactionsId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: voice_interactionsId, data }))
...
EditVoice_interactions.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default EditVoice_interactions
