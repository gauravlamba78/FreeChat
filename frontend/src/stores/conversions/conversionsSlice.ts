...
export const fetch = createAsyncThunk('conversions/fetch', async (data: any) => {
    const { id, query } = data
...
export const deleteItem = createAsyncThunk('conversions/deleteConversions', async (id: string, { rejectWithValue }) => {
    try {
...
export const create = createAsyncThunk('conversions/createConversions', async (data: any, { rejectWithValue }) => {
    try {
...
export const update = createAsyncThunk('conversions/updateConversions', async (payload: any, { rejectWithValue }) => {
    try {
