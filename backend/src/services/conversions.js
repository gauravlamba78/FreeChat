...
module.exports = class ConversionsService {
  ...
  static async update(data, id, currentUser) {
    const transaction = await db.sequelize.transaction();
    try {
      let conversions = await ConversionsDBApi.findBy(
        {id},
        {transaction},
      );
      ...
      const updatedConversions = await ConversionsDBApi.update(
        id,
        data,
        {
          currentUser,
